...
import { PanelComponentProps, usePanelDragContext } from "../core/Panels";
import {
  PanelContents,
  PanelContentsItem,
  PanelType,
} from "../../input-fields/PanelSelector";
import {
  javascript,
  javascriptLanguage,
  typescriptLanguage,
...
} from "../../../languages/typescript/editor/typescript";
import type ts from "typescript";
import { basicSetup } from "codemirror";
import { ImageEditorDragState } from "../implementation/ImageEditorPanels";
import { v4 } from "uuid";
import "./TextEditorPanel.css";
import { useDocumentation } from "./DocumentationPanel";
import { glslLanguageService } from "../../../languages/glsl/editor/glsl";
import { defaultEditorTheme, defaultSyntaxHighlightTheme } from "./theme";
            ...
            ? await typescriptLanguageService(
                ...
                props.data.file.path.split("/").slice(0, -1).join("/"),
                {
                  lib: [
                    ...
                    "src/evalbox/definitions/EvalboxDefs",
